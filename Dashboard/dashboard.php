        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between flex-wrap">
                <div  ="d-flex align-items-end flex-wrap">
                ...
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                  ...
                  <a class="btn btn-primary mt-2 mt-xl-0" href="createPost.php">Share Post</a>
                  <a class="btn btn-secondary mt-2 mt-xl-0" href="../mainBlog.php">All Post's</a>
                  <a class="btn btn-secondary mt-2 mt-xl-0" href="../sign.php?T=AD">Admin Sign</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Recent Account's</p>
                    ...
                    <table id="recent-purchases-listing" class="table">
                      <thead>
                        <tr>
                            ...
                            <th>Status</th>
                            <th>Type</th>
                            <th>Change the status of user</th>
                        </tr>
                      </thead>
                      <tbody>
                  ...
                  if ($count != 0) {
                      while ($row = mysqli_fetch_assoc($result)):
                        if ($row['id'] == $_SESSION['id']) {$row = mysqli_fetch_assoc($result);}
                          ...
                          <tr>
                              ...
                              <td>                          
                                  <a class="btn btn-sm btn-outline-secondary" href="changStatus.php?ty=Ac&id=<?php echo $row['id']; ?>">Active</a> | 
                                  <a class = "btn btn-sm btn-outline-secondary" href="changStatus.php?ty=In&id=<?php echo $row['id']; ?>">In Active</a>
                              </td>
                          </tr>
                          <?php
                      endwhile;
